        ...
        <div className="legal-content-wrapper">
          <div className="legal-section">
            ...
            <div className="legal-section-content">
              <p>
                AAU Nightlife Ekpoma ("we," "our," or "us") collects information you provide directly to us, such as when you:
              </p>
          ...
          <div className="legal-section">
            ...
            <div className="legal-section-content">
              ...
              <ul className="legal-list">
                ...
                <li>Process and display event and job listings</li>
          ...
          <div className="legal-section">
            <h2 className="legal-section-title">3. Information Sharing and Third-Party Services</h2>
            <div className="legal-section-content">
              <p>
          ...
          <div className="legal-section">
            <h2 className="legal-section-title">4. Cookies and Tracking Technologies</h2>
            <div className="legal-section-content">
              <p>
                Our website uses cookies and similar tracking technologies to enhance your experience, analyze site usage, and deliver relevant ads through Google AdSense. Cookies are small data files stored on your device. You can control or disable cookies through your browser settings, but some features may not function properly.
              </p>
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-section-content">
              <p>
                Our services are intended for users 18 years and older. We do not knowingly collect personal information from children under 18. If we learn we have collected personal information from a child under 18, we will delete that information.
              </p>
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-section-content">
              <p>
                We may update this privacy policy from time to time. We will notify you of any changes by posting the new policy on this page with an updated date. Your continued use of our service after such modifications constitutes acceptance of the updated policy.
              </p>
            </div>
          </div>
