            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginTop: 8, justifyContent: 'center' }}>
              {heroImages.map((img, idx) => (
                <div key={idx} style={{ position: 'relative', width: 80, height: 60 }}>
                  <img src={img} alt={`Hero ${idx + 1}`} style={{ width: 80, height: 60, objectFit: 'contain', background: '#222', borderRadius: 6, border: imgIdx === idx ? '2px solid #7bffb6' : '2px solid #fff', boxShadow: '0 2px 8px rgba(0,0,0,0.12)', display: 'block', margin: '0 auto' }} />
